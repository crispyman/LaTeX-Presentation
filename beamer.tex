...
% Creates a file in build directory
%\begin{filecontents*}{shell.sh}
%#!/usr/bin/env sh
%/usr/bin/make
%\end{filecontents*}
...
% Page 4
\begin{frame}[fragile]
\frametitle{starting a Document}
...
% Is supposed to rebuild the latex document
%\href{run:/usr/bin/make}{makestuff}
\input{cowsay}
\end{frame}
%Page 9
\begin{frame}
...
% you can set arbitrary font size useing an enviroment
\Huge
\textbf{
Questions?
}
...
% tiny is the smallest font size macro
% you can set arbitrary font size useing an enviroment
\tiny
\textit{
or not
...
\begin{frame}[fragile]
\begin{itemize}
\pause \item this is a Beamer
\pause \item Beamers are PDF's
\pause \item Each of these things is its own page in the PDF
\end{itemize}
\end{frame}
